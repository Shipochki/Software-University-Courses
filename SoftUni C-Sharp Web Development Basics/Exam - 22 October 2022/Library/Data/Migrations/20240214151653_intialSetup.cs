        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUsersBooks_AspNetUsers_ApplicationUserId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUsersBooks_Books_BookId1",
                        column: x => x.BookId1,
                        principalTable: "Books",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersBooks_ApplicationUserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersBooks_BookId1",
                table: "ApplicationUsersBooks",
                column: "BookId1");
